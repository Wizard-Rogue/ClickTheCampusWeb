# RailsAdmin config file. Generated on February 12, 2013 04:42
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Click The Campus', 'Admin']
  ...
  # config.excluded_models = ['Event', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Event', 'User']
